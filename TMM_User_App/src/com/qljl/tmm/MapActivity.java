...
public class MapActivity extends Activity implements OnClickListener,
	...
	private void showLocation() {
		...
		mGPSMarkerOption.icon(BitmapDescriptorFactory
		...
		public void onRegeocodeSearched(RegeocodeResult result, int rCode) {
			if (rCode == 0) {
				if (result != null
					...
					System.out.println("lw     addressName=="
	...
	public void onClick(View v) {
		...
		case R.id.fromLinear:// 跳转到出发点视角
			mAmap.animateCamera(CameraUpdateFactory.newLatLngZoom(
					AMapUtil.convertToLatLng(startLatLonPoint), 15));
			break;
		case R.id.toLinear:// 跳转到目的地视角
			mAmap.animateCamera(CameraUpdateFactory.newLatLngZoom(
					AMapUtil.convertToLatLng(endLatLonPoint), 15));
			break;
		default:
			break;
		}
	...
	private void render(Marker marker, View infoWindow) {
		...
		TextView snippetText = ((TextView) infoWindow

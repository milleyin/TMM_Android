...
/**
 * WebView does not support file: loading. This class wraps a file load with a
 * content provider. As HTMLViewer does not have internet access nor does it
 * allow Javascript to be run, it is safe to load file based HTML content.
 */
public class FileContentProvider extends ContentProvider {
	...
	public String getType(Uri uri) {
		// If the mimetype is not appended to the uri, then return an empty
		// string

...
package com.qljl.tmm_business.view;
...
public final class ViewfinderView extends View {
	 ...
	 * 四个蓝色边角对应的宽度
	 */
	private static final int CORNER_WIDTH = /* 16 */6;
	/**
	 * 扫描框中的中间线的宽度
	 */
	private static final int MIDDLE_LINE_WIDTH = /* 6 */2;
	...
	public void onDraw(Canvas canvas) {
		...
		if (resultBitmap != null) {
			...
			canvas.drawText(
					...
					frame.left, frame.bottom + TEXT_PADDING_TOP * density,
					paint);

...
import com.qljl.tmm.WebActivity;
...
public class UpdateManager {
	...
	private boolean isUpdate() {
		...
		try {
			...
			URL url = new URL("http://192.168.0.5/test/version.xml");
	...
	public void versionUpdate() {
		String url_first = "http://m.365tmm.com/index.php?r=admin/tmm_software/query&user=user&apk=apk";
		try {
			// 第一步，创建HttpGet对象
	...
	private void showNoticeDialog() {
		...
		noticeDialog.show();
		System.out.println("lw     noticeDialog.show();");
	}

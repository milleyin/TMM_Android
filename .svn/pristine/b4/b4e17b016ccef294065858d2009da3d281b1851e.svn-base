...
public class TestWebActivity extends Activity implements OnClickListener {
	...
	private void initView() {
		...
		webView.loadUrl("https://m.365tmm.com/user");
		setUrl("https://m.365tmm.com/user");
	...
	public void setUrl(String url) {
		...
		webView.setWebViewClient(new WebViewClient() {
			...
			public void onPageStarted(WebView view, String url, Bitmap favicon) {
				...
				System.out.println("lw  url 开始= " + url);
			...
			public void onLoadResource(WebView view, String url) {
				...
				System.out.println("lw  image = " + url);
			}

			@Override
			public void onReceivedError(WebView view, int errorCode,
					String description, String failingUrl) {
				System.out.println("lw 加载错误" + failingUrl);

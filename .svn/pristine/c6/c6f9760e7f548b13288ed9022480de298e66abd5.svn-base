...
public class CaptureActivity extends Activity implements Callback,OnClickListener {
	...
	private RadioButton /*scanRB,*/inputRB;
	private ImageView exitScanImg;
...
//		scanRB.setOnClickListener(this);
		inputRB = (RadioButton) findViewById(R.id.inputRB);
		inputRB.setOnClickListener(this);
		exitScanImg = (ImageView) findViewById(R.id.exitScanImg);
		exitScanImg.setOnClickListener(this);
	}
	...
	public void onClick(View v) {
		...
		case R.id.inputRB:
			Intent intent = new Intent();
			intent.setClass(CaptureActivity.this,InputCodeActivity.class);

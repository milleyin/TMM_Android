...
public class HttpHelper {
	...
	// public String ASSETS_NAME = /* "user.zip" */"business.zip";
	public String ASSETS_NAME = "user.zip";
	...
	// + "/tmm/files/";
	public String DB_PATH = "data/data/com.qljl.tmm/rar/";
	public String DB_TOPATH = "data/data/com.qljl.tmm/files/";
	public String DB_NAME = "user.zip";
	...
	public Object parseJSONString(int code, String jsonStr) throws Exception {
		if (jsonStr != "" || jsonStr != null) {
			...
			case 1:
				...
				return version_zip;
			case 2:
				// System.out.println("lw        jsonStr2 ----->" + jsonStr);
				// System.out.println("lw    logins--->"
				// + resultJson.getString("APP_CSRF"));
			...
			case 3:
				...
				vc.setUrl(url);
				// System.out.println("lw      down_url======>" + url);
				return vc;
			default:
				return null;
			}
	...
	public void hasUpdate() {
		// System.out.println("lw      _______hasUpdate");
		String url_first = "http://m.365tmm.com/index.php?r=admin/tmm_software/query&user=user&zip=zip";
//		 String url_first =
//		 "http://test.365tmm.net/index.php?r=admin/tmm_software/query&user=user&zip=zip";
		try {
			// 第一步，创建HttpGet对象
			HttpGet httpGet = new HttpGet(url_first);
			DefaultHttpClient httpClient = new DefaultHttpClient();
...
//				 System.out.println("lw      vc.getVersion()==="
//				 + vc.getVersion());
				if (vc.getVersion() > version_zip) {
//					System.out.println("lw       zip**************hasupdate!");
					// 下载zip
					doDownLoadWork(vc.getUrl());
				}
			} else {
				// System.out.println("lw      resultObj===null");
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public int getVersionZip() {
		try {
			Object resultObj = parseJSONString(1,
					getFileFromApp("data/data/com.qljl.tmm/files/user/version_zip"));
	...
	private String getFileFromApp(String path) {
		String result = "";
		try {
	...
	public int upZipFile(File zipFile, String folderPath) throws ZipException,
		...
		while (zList.hasMoreElements()) {
			...
			if (ze.isDirectory()) {
				String dirstr = folderPath + "user"/* ze.getName() */;
				// System.out.println("lw     dirstr====" + dirstr);
				// dirstr.trim();
		...
		zfile.close();
		System.out.println("lw        zip    jieya   finish~~~~~~~~~");
		return 0;
	}
	...
	public static File getRealFileName(String baseDir, String absFileName) {
		...
		if (dirs.length > 1) {
			...
			// System.out.println("lw   1ret = " + ret);
			if (!ret.exists())
				ret.mkdirs();
			...
			ret = new File(ret, substr);
			// System.out.println("lw   2ret = " + ret);
			return ret;
		}
		return ret;
	}

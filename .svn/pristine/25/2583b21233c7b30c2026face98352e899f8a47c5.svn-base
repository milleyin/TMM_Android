...
public class HttpHelper {
	...
	public String DB_TOPATH = Environment.getExternalStorageDirectory()
			+ "/tmm/files/";
	// public String DB_NAME = /* "user.zip" */"business.zip";
	...
	public Object parseJSONString(int code, String jsonStr) throws Exception {
		if (jsonStr != "" || jsonStr != null) {
			...
			case 3:
				...
				return vc;
				// if (version != 1) {
				// System.out.println("lw   down_url==="
				// + resultJson.getString("down_url"));
				// return resultJson.getString("down_url");
				// } else {
				// System.out.println("lw    url   null");
				// return null;
				// }
			default:
				return null;
	...
	public void hasUpdate() {
		...
		try {
			...
			// System.out.println("lw        version_zip**************"
			// + version_zip);
			if (resultObj != null) {
